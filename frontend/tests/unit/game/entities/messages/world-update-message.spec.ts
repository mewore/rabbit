...
describe('WorldUpdateMessage', () => {
    describe('when encoded and decoded', () => {
        it('should retain its value', () => {
            const original = new WorldUpdateMessage(123, [
                new PlayerState(2, 3, 4, 0, 0, new Vector3Entity(0.1, 0.2, 0.3), new Vector3Entity(0.4, 0.5, 0.6)),
                new PlayerState(5, 6, 7, 0, 0, new Vector3Entity(0.4, 0.5, 0.6), new Vector3Entity(0.1, 0.2, 0.3)),
            ]);
