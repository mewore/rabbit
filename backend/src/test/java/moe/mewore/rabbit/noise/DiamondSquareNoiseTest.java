...
class DiamondSquareNoiseTest {
    ...
    void testCreateSeamless() {
        final Noise noise = DiamondSquareNoise.createSeamless(3, random, false);
        assertEquals(0.22594186158633173, noise.get(0.1, 0.4));
    }

    @Test
    void testCreateSeamless_zeroAtCenter() {
        final Noise noise = DiamondSquareNoise.createSeamless(3, random, true);
    ...
    void testCreateSeamless_resolutionTooSmall() {
        final Exception exception = assertThrows(IllegalArgumentException.class,
            () -> DiamondSquareNoise.createSeamless(-1, random, true));
    ...
    void testCreateSeamless_resolutionTooLarge() {
        final Exception exception = assertThrows(IllegalArgumentException.class,
            () -> DiamondSquareNoise.createSeamless(42, random, true));
